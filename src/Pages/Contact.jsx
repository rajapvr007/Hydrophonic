            ...
            <div class="flex items-center justify-center">
              <div class="px-2 md:px-12">
                ...
                <form action="" class="mt-8 space-y-4 ">
                  ...
                  <button
                    // type="button"
                    class="w-full rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm"
                  >
                    Send Message
                  </button>
                </form>
